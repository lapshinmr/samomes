    ...
    <v-row>
      ...
      >
        ...
        <p>
          ...
          представленными ссылками на сайты и видео материалы сайта Youtube.
        </p>
        ...
        <p class="d-flex flex-column body-2">
          <a
            class="mb-2"
            href="https://www.youtube.com/watch?v=GSLYotAT8Xs&t=27s"
            target="_blank"
        ...
        <p class="d-flex flex-column body-2">
          ...
          <a
            class="mb-2"
            href="https://aquascape-promotion.com"
            target="_blank"
          >
