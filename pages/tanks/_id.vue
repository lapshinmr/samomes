          ...
          <v-row>
            ...
            >
              <number-field
                ...
                :rules="volumeRules"
              />
              <p class="grey--text text--darken-1 body-2 mt-2 mt-md-4">

                Это общий объем воды, который получилось залить в аквариум при запуске.
                ...
                с известным объемом или весов. Но если вы не знаете точное значение, то его можно
                ...
                мы не можем очень точно контролировать поглощение удобрений и опираемся по большей части
                на внешний вид растений. Другими словами, аквариум сам подскажет вам, что нужно уменьшить
                или увеличить дозировку удобрений.
              </p>
            </v-col>
            <v-col
              cols="12"
