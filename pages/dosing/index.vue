...
definePageMeta({
  ...
  meta: [
    {
      name: 'description',
      content: 'Здесь вы можете подобрать дозировки всех ваших удобрений с помощью удобной таблицы. Калькулятор ' +
    ...
    {
      name: 'keywords',
      content: 'аквариум, удобрения, дозировки, концентрация',
    },
  ],
});
</script>
