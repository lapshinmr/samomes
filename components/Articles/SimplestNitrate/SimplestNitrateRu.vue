  ...
  <v-row>
    ...
    >
      ...
      <div class="subtitle-2 mb-10">
        8 апреля 2023 (обновлено 10 июля 2025)
      </div>
      ...
      <p>
        ...
        необходимое количество калиевой селитры, которое в вашем случае составит 12.3 г.
      </p>
      ...
      <p>
        ...
        для вас. Однако есть ограничение: максимальная растворимость калиевой селитры составляет 316 грамма на литр.
      ...
      <v-row class="mb-6">
        ...
        >
          ...
          <v-alert
            ...
            variant="tonal"
          >
            Но это выходит за рамки данной статьи. Вы можете почитать о калии
            <nuxt-link :to="localePath('/articles/potassium/')">здесь.</nuxt-link>
          </v-alert>
        </v-col>
      </v-row>
