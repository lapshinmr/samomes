...
export default {
  ...
  recipes: {
    ...
    page: {
      ...
      reagentsDescription: 'In aquaristics, nitrogen and phosphorus concentrations are measured in the form of nitrates (NO₃⁻) and phosphates (PO₄³⁻), as these are the main compounds of these elements found in aquariums.',
      dilution: 'Dilution',
