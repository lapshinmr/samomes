...
export default {
  ...
  tanks: {
    ...
    page: {
      ...
      sectionDescription2: 'Here you can calculate the volume based on the linear dimensions of the tank',
      sectionDescription3: 'Here you can include the filter volume in the total aquarium volume. You can also specify the water change volume, which is used on other pages.',
      ...
      volumeWithFilter: 'Volume including filter',
