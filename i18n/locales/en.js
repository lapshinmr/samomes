  ...
  tanks: {
    ...
    page: {
      ...
      volumeInfo: {
        ...
        p3: 'Don\'t worry! You don\'t need to know the exact volume. An error of 10-20% will not lead to significant errors in fertilizer calculations, algae, or anything bad, since in the end we cannot very accurately control the absorption of fertilizers and rely on the appearance of plants.',
      },
      volumeHint: 'Enter volume in liters',
      orSizes: 'Calculate volume by dimensions',
      ...
      soilVolumeHint: 'Volume of water inside the substrate',
